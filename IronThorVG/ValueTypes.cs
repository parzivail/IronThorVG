...
public readonly record struct Color(byte R, byte G, byte B, byte A)
{
	...
	public static readonly Color DarkSeaGreen = new(143, 188, 143, 255);
	...
	public static readonly Color Gray = new(190, 190, 190, 255);
	...
	public static readonly Color LightGoldenrod = new(238, 221, 130, 255);
	...
	public static readonly Color LightSlateBlue = new(132, 112, 255, 255);
	...
	public static readonly Color NavyBlue = new(0, 0, 128, 255);
	...
	public static readonly Color Purple = new(160, 32, 240, 255);
	...
	public static readonly Color VioletRed = new(208, 32, 144, 255);
	...
	{
		return new Color((byte)(rgb >> 16), (byte)(rgb >> 8), (byte)rgb, 255);
	}
}
